...
/* This code is forked from Bryan Cutler's spark arrow flight example
...
( var prev: ArrowRDD, schema: StructType,
f: (TaskContext, Int, VectorSchemaRootIterator) => Iterator[U],
preservesPartitioning: Boolean = false,
isFromBarrier: Boolean = false, 
isOrderSensitive: Boolean = false)  extends RDD[U](prev.rdd) 
{
